> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 https://juejin.im/post/5b02cf8c6fb9a07aa632146d
...
![](https://user-gold-cdn.xitu.io/2018/5/21/16382faae2ba3581?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
通过 `@{userInfo.name}` 使 TextView 引用到相关的变量，DataBinding 会将之映射到相应的 **getter** 方法 之后可以在 Activity 中通过 `DataBindingUtil` 设置布局文件，省略原先 Activity 的 `setContentView()` 方法，并为变量 **userInfo** 赋值
...
![](https://user-gold-cdn.xitu.io/2018/5/21/16382faae2a3eb81?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2018/5/21/16382fab216044a6?imageslim) **可以看到，name 视图的刷新没有同时刷新 price 视图，而 details 视图刷新的同时也刷新了 price 视图**
...
![](https://user-gold-cdn.xitu.io/2018/5/21/16382faae57c15a7?imageslim)
...
![](https://user-gold-cdn.xitu.io/2018/5/21/16382faae59c42ae?imageslim)
...
![](https://user-gold-cdn.xitu.io/2018/5/21/16382faae5ac0682?imageslim)
...
![](https://user-gold-cdn.xitu.io/2018/5/21/16382fab1a890ad7?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2018/5/21/16382fab00ffefa2?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2018/5/21/16382fab02a2ce6e?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
这里提供上述示例代码的下载，或者你能在 GitHub 上给个 Star？

我的 GitHub 主页 -> [leavesC](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2FleavesC)

项目主页 -> [DataBinding_Demo](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2FleavesC%2FDataBinding_Demo)